...
<html>
<head>
	<title>Doding  Admin Page | Add New Products</title>
...
<body>
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Patient Disease</label>
    <div class="col-sm-10">
      <textarea class="form-control" name="description"><?=set_value('description') ?></textarea>
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Patient ID</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="price" placeholder="" value="<?=set_value('price') ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Checkup chedule</label>
    <div class="col-sm-10">
